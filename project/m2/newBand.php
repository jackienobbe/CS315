            ...
            <form class="new" action="viewBand.php" method="post">
              ...
              <div class="form-group">
                <label>Professionalism</label><br/>
                  pain in the butt
                  <input type="range" min="1" max="5" value="3" step="1" name="professionalism"/>
                  business in the front
              </div>
              <div class="form-group">
                <label>Music Quality</label><br/>
                  painful 4 all parties
                  <input type="range" min="1" max="5" value="3" step="1" name="quality" />
                  WOWMOM
              </div>
              <div class="form-group">
                <label>Energy</label><br/>
                  we checked 4 a pulse but...
                  <input type="range" min="1" max="5" value="3" step="1" name="energy" />
